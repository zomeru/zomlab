...
Schema: `APP_ENV` (`staging` or `production`), `VITE_SITE_URL`, `DATABASE_URL`, `E2E_PORT`, `BETTER_AUTH_SECRET`, `BETTER_AUTH_URL`, `GITHUB_CLIENT_ID/SECRET`, `GOOGLE_CLIENT_ID/SECRET`.
...
- `apps/web/worker-configuration.staging.d.ts` — generated by `wrangler types --env staging`
- `apps/web/worker-configuration.production.d.ts` — generated by `wrangler types --env production`
