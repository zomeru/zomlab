...
export const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    label: "Performance",
    items: [
      { label: "React Rendering", href: "/performance/react-rendering" },
      { label: "Memoization", href: "/performance/memoization" },
      { label: "Virtualization", href: "/performance/virtualization" },
      { label: "Lazy Loading", href: "/performance/lazy-loading" },
      { label: "Code Splitting", href: "/performance/code-splitting" },
      { label: "Caching", href: "/performance/caching" },
      { label: "Bundle Analysis", href: "/performance/bundle-analysis" },
      { label: "JavaScript", href: "/performance/javascript" },
      { label: "API", href: "/performance/api" },
      { label: "Database", href: "/performance/database" },
      { label: "Network", href: "/performance/network" },
      { label: "Concurrency", href: "/performance/concurrency" },
      { label: "Profiling", href: "/performance/profiling" },
    ],
  },
  {
    type: "section",
