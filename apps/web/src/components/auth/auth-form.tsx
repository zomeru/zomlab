    ...
    <div className="mx-auto w-full max-w-sm">
      <div className="rounded-xl border border-border bg-card p-6 sm:p-8">
        ...
        <form
          ...
          aria-busy={loading || socialLoading}
        >
          <fieldset disabled={!hydrated || loading || socialLoading} className="contents">
            ...
            <div className="mt-5 space-y-3">
              ...
              <button
                ...
                className="flex h-10 w-full items-center justify-center gap-2 rounded-md border border-border bg-background px-4 text-sm font-medium text-foreground transition-colors hover:bg-muted disabled:cursor-not-allowed disabled:opacity-60"
              >
